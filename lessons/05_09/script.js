...
newArticle.setAttribute("class", "backpack");
...
// main.replaceChild(newArticle)
// main.replaceChild(newArticle, pageHeader);
// main.insertBefore(newArticle, pageHeader);
// main.insertAdjacentElement("beforebegin", newArticle);
